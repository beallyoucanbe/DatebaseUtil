...
public class CacheServiceConfig {
    ...
    public static class CacheConfig{
        ...
        private Integer defExpire;   //缓存的存活时间

        public CacheConfig(String name, String type, String server, Integer poolSize, Integer defExpire) {
            this.name = name;
    ...
    private static CacheConfig initParam(String cacheName){
        ...
        try {
            ...
            throw new RuntimeException("缓存配置文件有误");
        }
    }
