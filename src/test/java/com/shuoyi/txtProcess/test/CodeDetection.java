...
public class CodeDetection {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String configFilePath = "C:/Users/zhaosy-c/Desktop/CombinationSum.java";
...
//        File file1 = new File("C:/Users/zhaosy-c/Desktop/CombinationSum.java");
//        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(file1)));
        String line = null;
        while ((line = in.readLine()) != null){
            System.out.println(line);
//            String other = new String(line.getBytes("utf-16"), "utf-8");
